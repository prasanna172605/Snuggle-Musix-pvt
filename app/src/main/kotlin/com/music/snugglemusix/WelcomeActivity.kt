...
import com.snuggle.music.constants.IsFirstRunKey
import com.snuggle.music.ui.theme.echomusicTheme
...
import com.snuggle.music.constants.AppLanguageKey
import com.snuggle.music.constants.SYSTEM_DEFAULT
import com.snuggle.music.constants.LanguageCodeToName
import com.snuggle.music.ui.component.EnumDialog
...
class WelcomeActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
            ...
            com.snuggle.music.utils.setAppLocale(this, locale)
        }
...
val GoogleSansFlex = FontFamily(
    Font(
        resId = com.snuggle.music.R.font.google_sans_flex,
...
fun WelcomePagerScreen(onFinished: () -> Unit) {
    ...
    val customWelcomeFontFamily = FontFamily(
        Font(
            resId = com.snuggle.music.R.font.sans_flex,
            variationSettings = FontVariation.Settings(
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    val welcomeText = "Welcome to Snuggle Musix"
                    ...
                    AssistChip(
                        ...
                        label = {
                            Text(
                                text = LanguageCodeToName.getOrElse(appLanguage) { stringResource(com.snuggle.music.R.string.system_default) },
                                fontFamily = GoogleSansFlex
                            )
                        },
                        leadingIcon = {
                            Icon(
                                painter = painterResource(id = com.snuggle.music.R.drawable.language),
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = stringResource(com.snuggle.music.R.string.perm_required),
                        style = thinHeaderStyle,
                        color = MaterialTheme.colorScheme.onBackground
                    )
                    Text(
                        text = stringResource(com.snuggle.music.R.string.perm_permissions),
                        fontFamily = GoogleSansFlex,
                    ...
                    Text(
                        text = stringResource(com.snuggle.music.R.string.perm_intro_text),
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            title = stringResource(com.snuggle.music.R.string.perm_notif_title),
                            description = stringResource(com.snuggle.music.R.string.perm_notif_desc),
                        ...
                        if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                            ...
                            PermissionCard(
                                ...
                                title = stringResource(com.snuggle.music.R.string.perm_install_title),
                                description = stringResource(com.snuggle.music.R.string.perm_install_desc),
        ...
        OnboardingPageInfo(
            content = { _ ->
                Column(
                    ...
                    Text(
                        text = "Snuggle Musix is open-source and depends on community support to grow. Your help makes a difference!",
                        style = MaterialTheme.typography.bodyLarge.copy(
                            fontFamily = GoogleSansFlex
                        ),
                        color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Column(
                        ...
                        PermissionCard(
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://github.com/prasanna172605/Snugle-Musix")
                            }
                        )
                        ...
                        PermissionCard(
                            icon = painterResource(com.snuggle.music.R.drawable.ic_instagram_new),
                            iconColor = Color(0xFFffb4ab),
                            iconTint = Color(0xFF690005),
                            title = "Follow on Instagram",
                            description = "Stay updated with the latest news from the developer.",
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://www.instagram.com/__prasannaaah__/?__pwa=1")
                            }
                        )
                        ...
                        PermissionCard(
                            icon = painterResource(com.snuggle.music.R.drawable.website),
                            iconColor = Color(0xFF67d4ff),
                            iconTint = Color(0xFF004e5d),
                            title = "Developer Website",
                            description = "Visit the developer's portfolio and other projects.",
                            shape = bottomCardShape,
                            control = {
                                Icon(
                                    imageVector = Icons.Rounded.ChevronRight,
                            ...
                            onClick = {
                                uriHandler.safeOpenUri(context, "https://prasanna0705.netlify.app/Snuggle-Musix")
                            }
                        )
            ...
            content = { onUpdateScroll ->
                Column(
                    ...
                    Column(modifier = Modifier.padding(bottom = 16.dp)) {
                        Text(
                            text = stringResource(com.snuggle.music.R.string.feat_discover),
                            style = thinHeaderStyle,
                            color = MaterialTheme.colorScheme.onBackground
                        )
                        Text(
                            text = stringResource(com.snuggle.music.R.string.feat_features),
                            fontFamily = GoogleSansFlex,
                            fontWeight = FontWeight.Bold,
                            fontSize = 48.sp,
                            color = MaterialTheme.colorScheme.primary,
                        ...
                        Text(
                            text = stringResource(com.snuggle.music.R.string.feat_intro),
                            style = MaterialTheme.typography.bodyLarge.copy(
                                fontFamily = GoogleSansFlex
                            ),
                            color = MaterialTheme.colorScheme.onSurfaceVariant
                    ...
                    Box(modifier = Modifier.weight(1f)) {
                        ...
                        Column(
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffaee4),
                                iconTint = Color(0xFF8d0053),
                                title = stringResource(com.snuggle.music.R.string.feat_lyrics_title),
                                description = stringResource(com.snuggle.music.R.string.feat_lyrics_desc),
                                shape = topCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                shape = middleCardShape,
                                title = stringResource(com.snuggle.music.R.string.feat_download_title),
                                description = stringResource(com.snuggle.music.R.string.feat_download_desc)
                            )
                            ...
                            FeatureCard(
                                ...
                                iconColor = Color(0xFFffb683),
                                iconTint = Color(0xFF753403),
                                title = stringResource(com.snuggle.music.R.string.feat_quality_title),
                                description = stringResource(com.snuggle.music.R.string.feat_quality_desc),
                                shape = middleCardShape
                            )
                            ...
                            if (BuildConfig.FLAVOR.contains("gms", ignoreCase = true)) {
                                ...
                                FeatureCard(
                                    ...
                                    iconColor = Color(0xFF67d4ff),
                                    iconTint = Color(0xFF004e5d),
                                    title = stringResource(com.snuggle.music.R.string.feat_update_title),
                                    description = stringResource(com.snuggle.music.R.string.feat_update_desc),
                                    shape = middleCardShape
                                )
                            }
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.snuggle.music.R.string.feat_license_title),
                                description = stringResource(com.snuggle.music.R.string.feat_license_desc),
                                shape = middleCardShape
                            )
                            ...
                            FeatureCard(
                                ...
                                title = stringResource(com.snuggle.music.R.string.feat_github_title),
                                description = stringResource(com.snuggle.music.R.string.feat_github_desc),
                                shape = bottomCardShape
                            )
            ...
            onSelect = { selectedLang ->
                scope.launch {
                    ...
                    if (Build.VERSION.SDK_INT < Build.VERSION_CODES.TIRAMISU) {
                        ...
                        com.snuggle.music.utils.setAppLocale(context, locale)
                        (context as? Activity)?.recreate()
                    }
                }
                showAppLanguageDialog = false
            },
            title = stringResource(com.snuggle.music.R.string.app_language),
            current = appLanguage,
            values = (listOf(SYSTEM_DEFAULT) + LanguageCodeToName.keys.toList()),
            valueText = {
                LanguageCodeToName.getOrElse(it) { stringResource(com.snuggle.music.R.string.system_default) }
            }
        )
    }
            ...
            Row(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = stringResource(com.snuggle.music.R.string.back_button_desc),
                        onClick = {
                            if (!isFirstPage) {
                                scope.launch {
                                    pagerState.animateScrollToPage(
                ...
                Box(
                    ...
                    WelcomeExpressiveButton(
                        text = if (isLastPage) stringResource(com.snuggle.music.R.string.get_started) else stringResource(
                            com.snuggle.music.R.string.next
                        ),
                        onClick = {
                            if (isLastPage) {
...
fun RotatingShapeContainer(modifier: Modifier = Modifier) {
    ...
    Box(
        ...
        Icon(
            painter = painterResource(id = com.snuggle.music.R.drawable.ic_ten_sided_cookie),
            contentDescription = null,
            tint = primaryColor,
            modifier = Modifier
                .fillMaxSize()
        ...
        Icon(
            painter = painterResource(com.snuggle.music.R.mipmap.ic_launcher_monochrome),
            contentDescription = null,
...
fun androidx.compose.ui.platform.UriHandler.safeOpenUri(context: android.content.Context, uri: String) {
    try {
        openUri(uri)
    } catch (e: Exception) {
