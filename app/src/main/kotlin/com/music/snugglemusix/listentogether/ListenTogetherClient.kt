...
package com.snuggle.music.listentogether
...
import com.snuggle.music.constants.ListenTogetherAutoApprovalKey
import com.snuggle.music.constants.ListenTogetherIsHostKey
import com.snuggle.music.constants.ListenTogetherRoomCodeKey
import com.snuggle.music.constants.ListenTogetherSessionTimestampKey
import com.snuggle.music.constants.ListenTogetherSessionTokenKey
import com.snuggle.music.constants.ListenTogetherUserIdKey
...
class ListenTogetherClient @Inject constructor(
    ...
    companion object {
        ...
        const val ACTION_APPROVE_JOIN = "com.snuggle.music.LISTEN_TOGETHER_APPROVE_JOIN"
        const val ACTION_REJECT_JOIN = "com.snuggle.music.LISTEN_TOGETHER_REJECT_JOIN"
        const val ACTION_APPROVE_SUGGESTION = "com.snuggle.music.LISTEN_TOGETHER_APPROVE_SUGGESTION"
        const val ACTION_REJECT_SUGGESTION = "com.snuggle.music.LISTEN_TOGETHER_REJECT_SUGGESTION"
    ...
    private fun loadBlockedUsernames() {
        try {
            val blockedJson = context.dataStore.get(com.snuggle.music.constants.ListenTogetherBlockedUsersKey, "")
    ...
    private suspend fun saveBlockedUsernames() {
        try {
            ...
            context.dataStore.edit { preferences ->
                preferences[com.snuggle.music.constants.ListenTogetherBlockedUsersKey] = blockedJson
            }
        } catch (e: Exception) {
    ...
    fun connect() {
        ...
        if (serverUrl.contains("hf.space") || serverUrl.contains("onrender.com")) {
            codec.format = MessageFormat.JSON
            codec.compressionEnabled = false
            log(LogLevel.INFO, "Using JSON format without compression for this server")
        } else {
            codec.format = MessageFormat.PROTOBUF
            codec.compressionEnabled = true
            log(LogLevel.INFO, "Using Protobuf format with compression for this server")
        }
