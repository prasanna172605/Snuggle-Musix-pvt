...
import com.snuggle.music.constants.MaxImageCacheSizeKey
import com.snuggle.music.constants.MaxSongCacheSizeKey
import com.snuggle.music.extensions.tryOrNull
...
import com.snuggle.music.ui.utils.formatFileSize
        ...
        ActionPromptDialog(
            ...
            onConfirm = {
                androidx.media3.exoplayer.offline.DownloadService.sendRemoveAllDownloads(
                    context,
                    com.snuggle.music.playback.ExoDownloadService::class.java,
                    false
                )
