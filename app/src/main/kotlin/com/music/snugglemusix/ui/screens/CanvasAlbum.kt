...
fun rememberAlbumCanvas(
    ...
    LaunchedEffect(albumTitle, artistName, firstSongTitle) {
        ...
        val fetched = withContext(Dispatchers.IO) {
            val nonNullAlbumTitle = albumTitle!!
            val nonNullArtistName = artistName!!
            val normalizedAlbumTitle = normalizeCanvasSongTitle(nonNullAlbumTitle)
            val normalizedFirstSongTitle = firstSongTitle?.let { normalizeCanvasSongTitle(it) }
            val normalizedArtistName = normalizeCanvasArtistName(nonNullArtistName)

            
            val searchTasks = linkedSetOf(
                normalizedAlbumTitle to normalizedArtistName,
                nonNullAlbumTitle to normalizedArtistName,
                normalizedAlbumTitle to nonNullArtistName,
                nonNullAlbumTitle to nonNullArtistName,
            )
            
            if (normalizedFirstSongTitle != null && firstSongTitle != null) {
