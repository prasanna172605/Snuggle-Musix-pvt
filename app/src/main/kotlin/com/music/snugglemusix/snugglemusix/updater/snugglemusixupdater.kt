...
package com.snuggle.music.snugglemusix.updater
...
import com.snuggle.music.snugglemusix.updater.downloadmanager.UpdateDownloadWorker
import com.snuggle.music.snugglemusix.updater.downloadmanager.DownloadNotificationManager
...
import com.snuggle.music.ui.component.ChangelogItem
import com.snuggle.music.ui.component.leadingItemShape
import com.snuggle.music.ui.component.middleItemShape
import com.snuggle.music.ui.component.endItemShape
import com.snuggle.music.ui.component.detachedItemShape
import com.snuggle.music.ui.component.parseMarkdown
import com.snuggle.music.ui.component.endItemShape
import com.snuggle.music.ui.component.detachedItemShape
import com.snuggle.music.ui.component.AnimatedActionButton
import com.snuggle.music.ui.component.ExpressiveIconButton
import com.snuggle.music.ui.component.ErrorSnackbar
                                ...
                                AnimatedActionButton(
                                    ...
                                    onClick = {
                                        if (isDownloadComplete) {
                                            ...
                                            val urlToDownload = currentStatus.apkUrl ?: "https://github.com/prasanna172605/Snugle-Musix/releases/download/${currentStatus.version}/SnuggleMusix-${cleanVersion}-Universal.apk"
                        ...
                        when (val currentStatus = status) {
                            ...
                            is EchoUpdateStatus.NoUpdate -> {
                                Column(
                                    ...
                                    AsyncImage(
                                        model = R.drawable.update_illustration,
                                    ...
                                    Column(
                                        ...
                                        Text(
                                            text = "What's New in Snuggle Musix",
                                        ...
                                        val changes = listOf(
                                            "Apple Music Inspired UI as the premium default music player layout.",
                                            "Canvas turned on by default for beautiful animated dynamic background tracks.",
                                            "Integrated new Listen Together real-time synchronized rooms.",
                                            "Saavn Fallback System with three links to ensure continuous streaming.",
                                            "Optimized memory usage, improved lyrics syncing, and faster search results."
                                        )
                                        ...
                                        changes.forEachIndexed { index, change ->
                                            ChangelogItem(
                                                text = change,
                                                shape = when (index) {
                                                    0 -> if (changes.size == 1) detachedItemShape() else leadingItemShape()
                                                    changes.lastIndex -> endItemShape()
...
suspend fun checkForUpdate(
    ...
    withContext(Dispatchers.IO) {
        try {
            val url = URL("https://api.github.com/repos/prasanna172605/Snugle-Musix/releases/latest")
            ...
            if (shouldShow) {
                ...
                try {
                    val changelogUrl =
                        URL("https://github.com/prasanna172605/Snugle-Musix/releases/download/$tagWithPrefix/changelog.json")
