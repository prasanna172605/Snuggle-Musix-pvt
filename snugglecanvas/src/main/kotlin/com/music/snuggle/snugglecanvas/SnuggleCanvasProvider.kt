package com.snuggle.music.snugglecanvas
...
@Serializable
data class SnuggleCanvasManifest(
    val items: List<SnuggleCanvasItem> = emptyList()
)

@Serializable
data class SnuggleCanvasItem(
    val song: String,
    val artist: String,
    val url: String
)

object SnuggleCanvasProvider {
    ...
    private data class CacheEntry(
        val value: SnuggleCanvasManifest?,
    ...
    private suspend fun fetchManifest(): SnuggleCanvasManifest? {
        ...
        return try {
            val manifest: SnuggleCanvasManifest = client.get(BASE_URL).body()
